...
def create_train
  ...
  type_train_user = gets.chomp.to_s
  puts "введите номер поезда"
  number_train = gets.chomp
  if type_train_user == "Пассажирский"
  train_user = PassengerTrain.new(number_train, type_train_user)
  elsif type_train_user == "Грузовой"
  train_user = CargoTrain.new(number_train, type_train_user)
  else
    puts "Можно создать либо Пассажирский либо Грузовой тип. Попробуйте еще раз."
    create_train
  end
